...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSArray *sbNames = @[@"HomeStoryboard",@"SearchStoryboard",@"SceneStoryboard",@"MeStoryboard"];
    ...
    for (NSString *sbName in sbNames) {
        ...
        BaseNavigationController *navi = [sb instantiateInitialViewController];
